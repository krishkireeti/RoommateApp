...
<div class="search">
  ...
  <input type="text" id="lname" name="lname" placeholder="Enter your lastname" required><br><br>
...
<input type="tel" id="phone" name="phone" placeholder="9876543210" pattern="[0-9]{10}" required><br>
...
export default {
    ...
    methods : {
        submitForm : function(){
var checkedYes = document.getElementById('yes').checked;
var checkedNo = document.getElementById('no').checked;
 ...
 this.message = "We will get back to you and find the matching details and contact you with the details you provided"
